...
extern stmt_pt new_stmt_Labelled(node_pt label, comment_block_pt com, stmt_pt stmt);
extern stmt_pt new_stmt_Case(file_pos_t pos, comment_block_pt com, node_pt expr, stmt_pt stmt);
extern stmt_pt new_stmt_Default(file_pos_t pos, comment_block_pt com, stmt_pt stmt);
extern stmt_pt new_stmt_Null(file_pos_t pos);
extern stmt_pt new_stmt_Expr(node_pt expr);
extern stmt_pt new_stmt_Compound(file_pos_t pos, symbol_pt decls, stmt_pt stmts);
extern stmt_pt new_stmt_If(file_pos_t pos, comment_block_pt com, node_pt cond, stmt_pt stmt);
extern stmt_pt
new_stmt_Ifelse(file_pos_t pos, comment_block_pt com, node_pt cond, stmt_pt then_stmt, stmt_pt else_stmt);
extern stmt_pt
new_stmt_Switch(file_pos_t pos, comment_block_pt com, node_pt cond, stmt_pt stmt);
extern stmt_pt new_stmt_While(file_pos_t pos, comment_block_pt com, node_pt expr, stmt_pt stmt);
extern stmt_pt new_stmt_Do(file_pos_t pos, comment_block_pt com, node_pt expr, stmt_pt stmt);
extern stmt_pt
new_stmt_For(file_pos_t pos, comment_block_pt com, node_pt e1, node_pt e2, node_pt e3, stmt_pt stmt);
