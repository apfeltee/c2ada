...
extern void gen_char_array(char* name, char* val, boolean is_wide_string, boolean is_const);

extern int should_import(void);
extern void print_string_value(char* val, int expected_len, boolean c_string);
