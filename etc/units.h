...
extern void unit_dependency(unit_n ord, unit_n dep, bool from_body);
...
extern bool unit_has_private_part(unit_n unit);
extern void set_unit_has_private_part(unit_n unit);

extern bool cur_unit_header_comment_set(void);
...
extern bool has_ellipsis(unit_n unit);

extern void set_unchecked_conversion(unit_n unit, bool in_spec);
extern bool has_unchecked_conversion(unit_n unit);
extern bool unchecked_conversions_to_spec(unit_n unit);

extern void with_c_pointers(unit_n unit);
extern bool has_c_pointers(unit_n unit);

extern void with_c_const_pointers(unit_n unit);
extern bool has_c_const_pointers(unit_n unit);
