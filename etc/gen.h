...
extern void
gen_var_or_field(symbol_t* sym, int tabpos, int colonpos, int import, char* rename, int hidden);
...
extern void gen_char_array(char* name, char* val, bool is_wide_string, bool is_const);

extern int should_import(void);
extern void print_string_value(char* val, int expected_len, bool c_string);
extern void print_char_value(int val);

extern void subtype_decl(char* subtype_name,
                         char* package_name,
                         char* type_name,
                         int indent,
                         node_t* ident,
...
extern void gen_subp(symbol_t* sym, char* rename, int is_spec, int is_inline, int is_interfaced);
...
extern void gen_access_type(symbol_pt sym, bool private_part);
...
extern char* char_to_string(int c, bool c_string);
