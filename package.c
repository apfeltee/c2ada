...
typeinfo_pt new_ptrs_type(typeinfo_pt element, typeinfo_pt pointer, ctxt_pt ctxt, file_pos_t pos)
{
...
typeinfo_pt ptrs_type_for(typeinfo_pt pointer, ctxt_pt ctxt, file_pos_t pos)
{
